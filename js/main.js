...
document.addEventListener("DOMContentLoaded", () => {
  const slides = document.querySelectorAll(".s-intro__slide");
  const dotsContainer = document.querySelector(".s-intro__dots");
  let current = 0;
  let interval;
  ...
  slides.forEach((_, index) => {
    ...
    dot.classList.add("s-intro__dot");
  ...
  const dots = document.querySelectorAll(".s-intro__dot");
